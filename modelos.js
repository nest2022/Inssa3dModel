export const modelos = {
  cafetera: {
    ...
    textos: [
      ...
      { label: "Menú de selección", position: [-3.75, 3, 4.5], ocultar: [2, 3, 4] }, 
    ...
    comentarios: [
      ...
      "Si deseas ocultar o mostrar los nombres y etiquetas informativas de las partes del modelo, utiliza el botón 'Info. 3D'. Esto te ayudará a visualizar el modelo sin distracciones.", // Ajustado de 2 a 1
      "¡Ahora puedes hacer clic en la llave para ABRIRLA!", 
      "La máquina Turín se distingue por su versatilidad, permitiendo dispensar hasta tres variedades de productos solubles, cada uno almacenado en su propio contenedor individual. Esta característica garantiza una oferta diversificada y optimiza la gestión de insumos.", // Ajustado de 4 a 3
      "¡Vuelve hacer clic en la llave para CERRARLA!", 
      "A continuación te presentamos el video tutorial para la respectiva programación.", 
      "A continuación te presentamos el video tutorial para la instalación de la red hídrica.", 
      "Esperamos que esta experiencia interactiva le haya permitido descubrir el potencial de nuestra máquina Turín. Para más información o para adquirir su unidad, no dude en contactarnos. ¡La eficiencia y calidad que busca están a un clic de distancia!", // Ajustado de 8 a 7
      "", 
    ],
    visibleObjectsConfig: [{ objectName: "Taza2", commentIndex: 7 }], 
    videosConfig: [
      { videoUrl: "https://www.youtube.com/embed/gfEwohi0YIM", commentIndex: 5 }, 
      { videoUrl: "https://www.youtube.com/embed/R8xifsK2IRk", commentIndex: 6 },
    ],
    ...
    purchaseCommentIndex: 8, 
    returnCommentIndexOnKeepExploring: 7, 
  },
  licuadora: {
    url: "GLB/Prueba1.glb",
    ...
    comentarios: [
      ...
      "Cuarto comentario de la licuadora. Esperamos que esta experiencia interactiva le haya permitido descubrir el potencial de nuestra licuadora. Para más información o para adquirir su unidad, no dude en contactarnos. ¡La eficiencia y calidad que busca están a un clic de distancia!", // Ajustado de 5 a 4
      "", 
    ],
    posicionInicial: [0, -1, 0],
    purchaseUrl: "https://www.innsa.com.co/licuadora-profesional",
    purchaseCommentIndex: 4, 
    returnCommentIndexOnKeepExploring: 3, 
  },
};
